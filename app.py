...
with col2:
    ...
    if solve_btn:
        ...
        fig, ax = plt.subplots(figsize=(6,5))  # slightly compact
        ...
        # STATION
        ax.scatter(0, 0, s=60)
        ax.text(0, -0.5, "Station", color='white', ha='center', fontsize=8)

        # COMPASS
        ax.text(0, 5.6, "N", color='white', ha='center', fontsize=8)
        ax.text(0, -5.6, "S", color='white', ha='center', fontsize=8)
